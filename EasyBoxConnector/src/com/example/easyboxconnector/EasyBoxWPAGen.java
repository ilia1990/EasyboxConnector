...
// Taken from http://www.wotan.cc/?p=6


public class EasyBoxWPAGen {
	public static String GENERATE_WPA_KEY (String mac) throws Exception{
		String wpaKey = "";
		...
		if (mac.length() == 12){
			...
			throw new Exception("Error: MAC-Address must have 12 digits!");
		}
